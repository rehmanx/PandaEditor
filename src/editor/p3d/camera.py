...
class Camera(NodePath, SingleTask):
    ...
    def __init__(self, name='EdCamera', *args, **kwargs):
    ...
    def cameraMovement(self, task):
        ...
        self.setX(self.getX() - ((self.getX() - x - 18 * self.zoomLevel) * 5 * base.globalClock.getDt()))
        self.setY(self.getY() - ((self.getY() - y + 5 * self.zoomLevel) * 5 * base.globalClock.getDt()))
